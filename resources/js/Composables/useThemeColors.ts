...
export function useThemeColors() {
    ...
    const colors = computed(() => {
        ...
        return {
            ...
            buttonSecondaryText: getContrastingTextColor(currentTheme.secondary),
            ...
            overlayText: getContrastingTextColor(addAlpha(currentTheme.primary, 0.8)),
    ...
    const utils = {
         ...
         */
        getThemeColorWithAlpha: (colorKey: keyof typeof theme.value, alpha: number) => {
